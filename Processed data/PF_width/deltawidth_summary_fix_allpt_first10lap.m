...
%% change to all point 
fit_tilllap=10;
CA1_f_model=fitlm(CA1_f_x(CA1_f_x<=fit_tilllap), CA1_f_y(CA1_f_x<=fit_tilllap));
plot(CA1_f_x(CA1_f_x<=fit_tilllap),CA1_f_model.('Coefficients').('Estimate')(2).*CA1_f_x(CA1_f_x<=fit_tilllap)+ CA1_f_model.('Coefficients').('Estimate')(1),'color',usecolor1);
...
text(8,0.8, ['CA1 f p-value ' num2str(CA1_f_p)])
text(8,0.75, ['CA1 f R-square ' num2str(CA1_f_R2)])

CA1_nday1_model=fitlm(CA1_nday1_x(CA1_nday1_x<=fit_tilllap),CA1_nday1_y(CA1_nday1_x<=fit_tilllap));
plot(CA1_nday1_x(CA1_nday1_x<=fit_tilllap),CA1_nday1_model.('Coefficients').('Estimate')(2).*CA1_nday1_x(CA1_nday1_x<=fit_tilllap)+ CA1_nday1_model.('Coefficients').('Estimate')(1),'color',usecolor2);
%CA1_nday1_confidance=coefCI(CA1_nday1_model,0.001)CA3_nday1_summary=anova(CA3_nday1_model,'summary');
...
text(8,1.15, ['CA1 nday1 p-value ' num2str(CA1_nday1_p)])
text(8,1.1, ['CA1 nday1 R-square ' num2str(CA1_nday1_R2)])


CA1_nday2_model=fitlm(CA1_nday2_x(CA1_nday2_x<=fit_tilllap),CA1_nday2_y(CA1_nday2_x<=fit_tilllap));
plot(CA1_nday2_x(CA1_nday2_x<=fit_tilllap),CA1_nday2_model.('Coefficients').('Estimate')(2).*CA1_nday2_x(CA1_nday2_x<=fit_tilllap)+ CA1_nday2_model.('Coefficients').('Estimate')(1),'color',usecolor3);
...
text(8, 1.3, ['CA1 nday2 p-value ' num2str(CA1_nday2_p)])
text(8, 1.25, ['CA1 nday2 R-square ' num2str(CA1_nday2_R2)])
%%
subplot(1,2,2)
...
CA3_f_model=fitlm(CA3_f_x(CA3_f_x<=fit_tilllap), CA3_f_y(CA3_f_x<=fit_tilllap));
plot(CA3_f_x(CA3_f_x<=fit_tilllap),CA3_f_model.('Coefficients').('Estimate')(2).*CA3_f_x(CA3_f_x<=fit_tilllap)+ CA3_f_model.('Coefficients').('Estimate')(1),'color',usecolor1);
...
text(8,0.85, ['CA3 f p-value ' num2str(CA3_f_p)])
text(8,0.75, ['CA3 f R-square ' num2str(CA3_f_R2)])


CA3_nday1_model=fitlm(CA3_nday1_x(CA3_nday1_x<=fit_tilllap), CA3_nday1_y(CA3_nday1_x<=fit_tilllap));
plot(CA3_nday1_x(CA3_nday1_x<=fit_tilllap),CA3_nday1_model.('Coefficients').('Estimate')(2).*CA3_nday1_x(CA3_nday1_x<=fit_tilllap)+ CA3_nday1_model.('Coefficients').('Estimate')(1),'color',usecolor2);
...
text(8,1.15, ['CA3 nday1 p-value ' num2str(CA3_nday1_p)])
text(10,1.1, ['CA3 nday1 R-square ' num2str(CA3_nday1_R2)])


CA3_nday2_model=fitlm(CA3_nday2_x(CA3_nday2_x<=fit_tilllap), CA3_nday2_y(CA3_nday2_x<=fit_tilllap));
plot(CA3_nday2_x(CA3_nday2_x<=fit_tilllap),CA3_nday2_model.('Coefficients').('Estimate')(2).*CA3_nday2_x(CA3_nday2_x<=fit_tilllap)+ CA3_nday2_model.('Coefficients').('Estimate')(1),'color',usecolor3);
...
text(8,1.3, ['CA3 nday2 p-value ' num2str(CA3_nday2_p)])
text(8,1.25, ['CA3 nday2 R-square ' num2str(CA3_nday2_R2)])
...
plot(lap_range(1:10),CA1_nday1_model.('Coefficients').('Estimate')(2).*lap_range(1:10)+ CA1_nday1_model.('Coefficients').('Estimate')(1),'color',usecolor4);
...
plot(lap_range(1:10),CA3_nday1_model.('Coefficients').('Estimate')(2).*lap_range(1:10)+ CA3_nday1_model.('Coefficients').('Estimate')(1),'color',usecolor5);
%title(['slope=' num2str(a)]);
...
plot(lap_range(1:10),CA1_nday2_model.('Coefficients').('Estimate')(2).*lap_range(1:10)+ CA1_nday2_model.('Coefficients').('Estimate')(1),'color',usecolor4);
%title(['slope=' num2str(a)]);
...
plot(lap_range(1:10),CA3_nday2_model.('Coefficients').('Estimate')(2).*lap_range(1:10)+ CA3_nday2_model.('Coefficients').('Estimate')(1),'color',usecolor5);
%title(['slope=' num2str(a)]);
