function [meanCOM_first5 meanCOM_last5 Act_lapnum norm_act_COMshift norm_from_startCOMshift total_lapstart]=find_firstlastCOM(sig_PFs,common_PC_id,PF_start_bins,PF_end_bins,numbins,all_bins,ave_bin)
start_bin=1;
end_bin=50;
window=6;
threshold=3;
