...
all_bins=true;
ave_bin=1;
[f_meanCOM_first5 f_meanCOM_last5  f_Act_lapnum f_norm_act_COMshift f_norm_from_startCOMshift f_startlap]=find_firstlastCOM(f_sig_PFs,f_sig_PFs,f_pf_id,f_PF_start_bins,f_PF_end_bins,numbins,all_bins,ave_bin);
[n_meanCOM_first5 n_meanCOM_last5  n_Act_lapnum n_norm_act_COMshift n_norm_from_startCOMshift n_startlap]=find_firstlastCOM(n_sig_PFs,n_sig_PFs,n_pf_id,n_PF_start_bins,n_PF_end_bins,numbins,all_bins,ave_bin);

[day1_meanCOM_first5 day1_meanCOM_last5  day1_Act_lapnum day1_norm_act_COMshift day1_norm_from_startCOMshift day1_startlap]=find_firstlastCOM(f_sig_PFs,n_sig_PFs,common_PC_id,f_PF_start_bins,f_PF_end_bins,numbins,all_bins,ave_bin);
[day2_meanCOM_first5 day2_meanCOM_last5  day2_Act_lapnum day2_norm_act_COMshift day2_norm_from_startCOMshift day2_startlap]=find_firstlastCOM(n_sig_PFs,f_sig_PFs,common_PC_id,n_PF_start_bins,n_PF_end_bins,numbins,all_bins,ave_bin);
...
% [shuffle_h shuffle_p]=kstest2(total_twoday_shift,shuffle_2day_shift)
 ...
 hold on;histogram(total_twoday_shift*6,(-50:2:50)*6,'Normalization','Probability')
 [sym_p sym_h stats]=signrank(total_twoday_shift)
 %legend('shuffle','across days')
 xlabel('cm')
 title(['across day shift.sign rank test p=' num2str(sym_p)])
%[sym_p sym_h]=signrank(total_twoday_shift)
%line([median(total_twoday_shift) median(total_twoday_shift)],[0 0.2])
...
% 
%     errorbar(lap_range,cur_mean_ny,cur_n_sem,'-o')
...
% 
%     histogram(cur_n_y(cur_n_x==i+1),-9.5:1:9.5);
...
%%
%save('CA1_n2day_shift','f_shift_dist_M','n_shift_dist_M','total_f_act_shift','total_n_act_shift')
