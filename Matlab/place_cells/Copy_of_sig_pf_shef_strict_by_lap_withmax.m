...
if startF>300
if num_of_lap(1)==1
 save([behavior_filepaths(1:end-4) '_n_PF_strict_1st25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id');%,'-append');
elseif num_of_lap(1)==11
    save([behavior_filepaths(1:end-4) '_n_PF_strict_late15lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id');%,'-append');
elseif num_of_lap(1)==26
    save([behavior_filepaths(1:end-4) '_n_PF_strict_2nd25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id');%,'-append');
end
else 
if num_of_lap(1)==1
 save([behavior_filepaths(1:end-4) '_f_PF_strict_1st25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id');%,'-append');
elseif num_of_lap(1)==11
    save([behavior_filepaths(1:end-4) '_f_PF_strict_late15lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id');%,'-append');
elseif num_of_lap(1)==26
    save([behavior_filepaths(1:end-4) '_f_PF_strict_2nd25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id');%,'-append');
end
end
