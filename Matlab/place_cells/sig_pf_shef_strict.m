...
save([behavior_filepaths(1:end-4) '_f_PF_strict_1st10min'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans');%,'-append');
