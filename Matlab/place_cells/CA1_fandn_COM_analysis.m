...
PF_info(n_combine_id{plane}).PF_empty=n_PF_empty{plane};
 ...
 save([PF_info(1).filepaths(1:17) '_COM_and_SP'],'PF_info','-v7.3');%'f_SP','f_COM','n_SP','f_COM','f_combine_pfid','n_combine_pfid','f_PF_empty','n_PF_empty','f_sig_PF','n_sig_PF');
