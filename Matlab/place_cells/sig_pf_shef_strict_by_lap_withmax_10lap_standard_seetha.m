...
switched_world=input(['Is this a switched dataset? ']);
...
% end
save([behavior_filepaths(1:end-4) '_day2NCFCtest'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','empty_id','parameters');%,'cell_ROI','-append');
