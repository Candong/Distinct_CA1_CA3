...
empty_id=[];
% empty_id=(13560:14290)-startF;
% Fc3_DF(empty_id,:)=[];
% Fc2(empty_id,:)=[];
% ybinned(:,empty_id)=[];
% 3-1 day1 13910:14110 day2 13560:14290; 4-3 day1 16950,17110
...
if startF>300
if num_of_lap(1)==1
 save([behavior_filepaths(1:end-4) '_n_PF_strict_1st25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id','parameters');%,'-append');
elseif num_of_lap(1)==11
    save([behavior_filepaths(1:end-4) '_n_PF_strict_late15lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id','parameters');%,'-append');
elseif num_of_lap(1)==26
    save([behavior_filepaths(1:end-4) '_n_PF_strict_2nd25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id','parameters');%,'-append');
end
else
    
if last==1
 save([behavior_filepaths(1:end-4) '_f_PF_strict_last25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id','parameters');%,'-append');
elseif num_of_lap(1)==1
 save([behavior_filepaths(1:end-4) '_f_PF_strict_1st25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id','parameters');%,'-append');
elseif num_of_lap(1)==11
    save([behavior_filepaths(1:end-4) '_f_PF_strict_late15lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id','parameters');%,'-append');
elseif num_of_lap(1)==26
    save([behavior_filepaths(1:end-4) '_f_PF_strict_2nd25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax','cell_ROI','empty_id','parameters');%,'-append');
