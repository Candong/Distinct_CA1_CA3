...
for i=1:size(PF_info,2)
  if contains(PF_info(i).filepaths,'_f_')
     ...
     if contains(PF_info(i).filepaths,'late15lap')
          ...
          f_late15_id{3}=i;
          f_late15_pfnum{3}=PF_info(i).number_of_PFs;
          end
      ...
      elseif contains(PF_info(i).filepaths,'1st25lap')
          ...
          elseif contains(PF_info(i).filepaths,'plain3')
          f_1st25_pfid{3}=PF_info(i).place_cell_id;
          f_1st25_id{3}=i;      
          f_1st25_pfnum{3}=PF_info(i).number_of_PFs;
          end
...
PF_info(f_1st25_id{plane}).combinebineMean=f_binmean;
...
for i=1:size(PF_info,2)
  if contains(PF_info(i).filepaths,'_n_')
      ...
      if contains(PF_info(i).filepaths,'1st25lap')
          ...
          elseif contains(PF_info(i).filepaths,'plain3')
          n_1st25_pfid{3}=PF_info(i).place_cell_id;
          n_1st25_id{3}=i; 
          n_1st25_pfnum{3}=PF_info(i).number_of_PFs;
          end
      ...
      elseif contains(PF_info(i).filepaths,'late15lap')
          ...
          n_late15_id{3}=i;
          n_late15_pfnum{3}=PF_info(i).number_of_PFs;
          end
...
for i=n_potential_samepf{p} 
    if ~isempty(i)
load([temp behavior_filepaths{n_1st25_id{p}}]);
    for j=1:size(sig_PFs,1)
...
PF_info(n_1st25_id{plane}).combinebineMean=n_binmean;
