...
standardlap=12;
stoplap=25;
[f_x f_y f_jump_y f_jump_x f_x_M f_y_M]=linreg_for_bylap_groupedCOM(f_sig_PFs,f_pf_id,f_norm_act_COMshift,f_startlap,stepsize,standardlap,stoplap);
[n_x n_y n_jump_y n_jump_x n_x_M n_y_M]=linreg_for_bylap_groupedCOM(n_sig_PFs,n_pf_id,n_norm_act_COMshift,n_startlap,stepsize,standardlap,stoplap);
...
title('CA3 n day1 and day2')
 ...
 save(['new_CA3_novel2day_deltaCOM_' num2str(stoplap)],'f_x','f_y','n_x','n_y','f_jump_y','n_jump_y',...
  'f_jump_x','n_jump_x','f_x_M','f_y_M','n_x_M','n_y_M');
