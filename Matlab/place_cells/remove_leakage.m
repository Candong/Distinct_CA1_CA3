...
[figure_filepaths, fig_temp]=uigetfile('*.mat', 'Chose figure to load:','MultiSelect','on');
...
%           
%       end
   if ssimval>thres_calculator(base_threshold,dist_threshold,cur_dis)
       overlap=1;
   end
      if overlap==1
