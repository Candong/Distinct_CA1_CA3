...
%% correct E
    wrong_lap=0;
    for i=1:max(E)
%         if wrong_lap==1 % incase some flacutation has been picked up
%         onpoint=find(E==i-1,1);
%         offpoint=find(E==i,1,'last');
%         else

%         if i==1
%         onpoint=find(E==i,1);
%         if E(onpoint)>trackstart
%             E(E~=0)=E(E~=0)-1;
%         end
%         
%         end
...
if startF>100
if num_of_lap(1)==1
 save([behavior_filepaths(1:end-4) '_n_PF_strict_1st25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax');%,'-append');
elseif num_of_lap(1)==11
    save([behavior_filepaths(1:end-4) '_n_PF_strict_late15lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax');%,'-append');
elseif num_of_lap(1)==26
    save([behavior_filepaths(1:end-4) '_n_PF_strict_2nd25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax');%,'-append');
end
else 
if num_of_lap(1)==1
 save([behavior_filepaths(1:end-4) '_f_PF_strict_1st25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax');%,'-append');
elseif num_of_lap(1)==11
    save([behavior_filepaths(1:end-4) '_f_PF_strict_late15lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax');%,'-append');
elseif num_of_lap(1)==26
    save([behavior_filepaths(1:end-4) '_f_PF_strict_2nd25lap'],'sig_PFs','sig_PFs_with_noise','PF_width','PF_rate','PF_start_bins','PF_PVALS','PF_end_bins','number_of_PFs','mean_trans','label_high','label_low','ybinmax');%,'-append');
end
end
